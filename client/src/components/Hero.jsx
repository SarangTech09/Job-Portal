  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
        <div className='bg-linear-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
            ...
            <p className='mb-8 max-w-xl mx-auto text-sm font-light px-5'>Your Next Big Career Move Starts Right Here - Explore the Best Opportunities that Match Your Skills and Experience, and Take the First Step Toward Your Future!</p>
