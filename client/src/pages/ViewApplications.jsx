            ...
            {applicants.filter(item => item.jobId && item.userId).map((applicant, index) => (
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 border-b'>
                  <a href={applicant.userId.resume} target='_blank' className='bg-blue-50 text-blue-400 px-3 py1 rounded inline-flex gap-2 items-center'>
                ...
                <td className='py-2 px-4 border-b relative'>
                  ...
                  ? <div className='relative inline-block text-left group'>
                    <button className='text-gray-500 px-2 action-button'>...</button>
                    <div className='z-10 hidden absolute right-0 md:left-0 top-full mt-1 w-32 bg-white border border-gray-200 rounded shadow group-hover:block'>
